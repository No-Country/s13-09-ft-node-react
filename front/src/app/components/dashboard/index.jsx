...
export function DashBoardComponents() {
    ...
    return         <div className="text-black flex flex-col gap-20 m-auto mt-20 mb-8 w-[80%] max-md:w-[95%] max-md:items-center">
    <div className="flex gap-12 flex-col max-md:items-center">
        <h2 className="text-[#0234A1] text-3xl font-semibold ">¡Bienvenido {data?.patient?.name || "Tomas"}!</h2>
